    ...
    theme: {
        ...
        extend: {
            ...
            fontSize: {
                ...
                'display-sm': ['5rem', { lineHeight: '1', letterSpacing: '-0.02em', fontWeight: '700' }],
                'hero': ['7rem', { lineHeight: '1', letterSpacing: '-0.02em', fontWeight: '700' }],
                'stat': ['8rem', { lineHeight: '1', letterSpacing: '-0.02em', fontWeight: '100' }],
                'stat-sm': ['6rem', { lineHeight: '1', letterSpacing: '-0.02em', fontWeight: '100' }],
            },
            colors: {
